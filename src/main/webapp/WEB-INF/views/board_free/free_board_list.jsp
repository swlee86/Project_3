					...
					<div class="table-responsive">
						<table cellpadding="1" cellspacing="1" class="table  table-hover"
                        	...
                        	&nbsp;&nbsp;&nbsp;
											...
											href="free_board_view.do?no=${list.no}&currentpage=${cpage}&pagesize=${pgsize}">${list.title}</a>
						...
						<div class="row" style="text-align: right; margin-right: 5px;">
							<button type="button" class="btn w-xs btn-success"
								onclick="location.href='free_board_write.do?&currentpage=${cpage}&pagesize=${pgsize}'">글
								등록</button>
						</div>
					</div>
