					...
					<form class="form-horizontal">
 						<div class="row">
							<div class="form-group col-lg-12">
								<label class="col-md-offset-4 col-md-2 control-label" style="text-align: center;">찾으신 아이디는 : </label>
								<label class="col-md-2 control-label" style="text-align: center;">사번</label>
							</div>
							<br/>
						</div>
