	...
	<div class="row">
		<div class="col-lg-12">
			<div class="hpanel">
				...
				<div class="panel-body">
					<div class="row text-right" style="text-align:right; margin-right:5px;">
				                    	...
				                    	<div class="form-group">
											<div class="input-group">
			                    				...
			                    				<span class="input-group-btn">
			                    					<button class="btn input-sm btn-default" type="button" value="" onclick="searchPj()" style="color:#f05050">
				...
				<div class="table-responsive" id="projectList">
					<table cellpadding="1" cellspacing="1" class="footable table table-hover table-striped" >
						<thead>
							<tr>
								<th>책임자</th>
								<th>부&nbsp;서</th>
...
<script>
	...
	function selectCtg(){  // 테이블 전체 새로고침
		...
		var makeTable = ""; // append시킬 태그
		 ...
		 makeTable = 
			 "<table cellpadding='1' cellspacing='1' class='footable table table-hover table-striped'><thead>"+
