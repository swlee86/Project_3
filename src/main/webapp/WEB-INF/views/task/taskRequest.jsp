									...
									<table style="margin-top: 10px; margin-bottom: 10px;" width="100%">
										<tr>
											...
											<select class="form-control input-sm" 
												...
												<option value="emp_no">요청자</option>
								...
								<table cellpadding="1" cellspacing="1" class="table table-hover">
									...
									<tbody id="firstTable">
										<c:forEach var="list" items="${list1}">
											<tr>
												<td style="padding-top: 12px;"><input type="checkbox"
												...
												<td style="padding-top: 12px;"><a
													href="taskRequest_rec_detail.do?task_no=${list.task_no}">${list.task_name}</a></td>
									...
									<tbody id="secondTable">
										<c:forEach var="list2" items="${list2}">
											<tr>
												...
												<td style="padding-top: 12px;"><a
													href="taskRequest_detail.do?task_no=${list2.task_no}">${list2.task_name}</a></td>
									...
									<tbody id="thirdTable">
										<c:forEach var="list3" items="${list3}">
											<tr>
												...
												<td style="padding-top: 12px;"><a
													href="taskRequest_participation_detail.do?task_no=${list3.task_no}">${list3.task_name}</a></td>
												...
												<td style="padding-top: 12px;"><c:choose>
														<c:when test="${list3.step_no == '4'}">
															<button class="btn btn-xs btn-warning2">미승인</button>
														</c:when>
														<c:when test="${ list3.step_no == '1'}">
															<button class="btn btn-xs btn-info">승인</button>
														</c:when>
