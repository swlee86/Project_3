            ...
            <div class="panel-body">
            	<div class="row" style="background-color:#f3f3f3">
	            	<form action="" class="form-inline">
	            		<table style="margin-top:10px; margin-bottom:10px;" width="100%">
	                 		<tr > 
	                 			<td width="10%"></td>
	                 			<th style="text-align:right;padding-right:20px;">요청자 </th>
	                 			<td><input type="text" class="form-control input-sm" style="width:60%; height: 27px; "></td>
	                 			<td width="10%"></td>
	                 			<th style="text-align:right;padding-right:20px;">업무기한 </th>
	                 			<!-- <td><input type="text" class="form-control input-sm" style="width:60%; height: 27px;"></td>
	                 			<td width="10%"></td> -->
	                 			<td>
	                 				<div class="input-group date">
										<input type="text" class="form-control" id="start" size="20px">
	                 		...
	                 		<tr>
	                 			<td></td>
	                 			<th style="text-align:right;padding-right:20px;">업무명 </th>
	                 			<td><input type="text" class="form-control input-sm" width="100%" style="width:100%; height: 27px;"></td>
	                 			<td></td>
	                 			<td></td>
	                 			<td><button class="btn btn-sm" style="background-color:#68a84b;color:white" type="submit"><span class="fa fa-search"></span>&nbsp; 검색  &nbsp;</button></td>
	                 			<td></td>
	                 		</tr>            
	               		</table>
	                </form>   
                ...
                <table cellpadding="1" cellspacing="1" class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>4</td>
                        <td><i class="fa fa-star" style="color:#ffc02b; border-color: black;"></i></td>
                        <td><a href="taskRequest_rec_detail.do">UI/UX 구현</a></td>
                        <td>2016-11-16</td>
                        <td>김주희</td>
                        <td>2016-11-15</td>
                    
                        <td><button class="btn btn-sm" style="background-color: #68a84b;color:white">미승인</button></td>
 <!--                        <td><a class="btn btn-danger" style="background-color: #68a84b; border: 0px;" href="#">미승인</a></td> -->
                        <td>
                ...
                <div class="row" style="text-align:right; margin-right:5px;">
                	<button type="button"  class="btn w-xs btn-primary" onclick="window.location.href='#'">업무 등록</button>
                	<button type="button"  class="btn w-xs btn-default" data-dismiss="modal" data-toggle="modal" data-target="#myModal1">삭제</button>
                </div>
			</div>
