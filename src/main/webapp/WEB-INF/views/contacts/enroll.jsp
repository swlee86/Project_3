				...
				<div class="panel-body">
					<div class="table-responsive">
										...
										<td>	
											<div class="form-group">	
												<div class="input-group">
													<input type="text" class="form-control input-sm" placeholder="이름을 입력하세요." name="name" id="enrol_name" />
						...
						<div class=" pull-right" style="text-align:center;">
								<input type="submit"  id="submit_btn" class="btn btn-sm btn-success" value="등록" style="padding-right:15px;padding-left:15px;font-weight:600;font-size:13px">
