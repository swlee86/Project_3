...
<div class="row">
           ...
           <div class="col-md-3">
            <div class="hpanel panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="panel-body">
                	<button type="button" class="btn btn-outline btn-block btn-success">주소록 등록</button>             
                </div>
                <div class="panel-body">
                    <h4 class="m-t-none m-b-none"><a href="#">전체 주소록</a></h4>              
                </div>
                <div class="panel-body">
                ...
                <div class="panel-body" style="text-align:center">
                	<button type="button" class="btn btn-outline btn-success">주소록 그룹 추가</button>&nbsp;&nbsp;&nbsp;&nbsp;
                	<button type="button" class="btn btn-outline btn-success">주소록 그룹 삭제</button>             
                </div>
            </div>
        </div> 
    ...
    <div class="col-md-9">
        ...
        <div class="hpanel">
            ...
            <div class="panel-body">
                   		...
                   		<div class="row">
					    <div class="col-lg-6">
					        <div class="hpanel hred contact-panelt">
					            <div class="panel-body">
             ...
             <div class="panel-footer"  style="text-align:center">
              ...
              <br>
              <button type="button" class="btn btn-outline btn-primary">삭제</button>&nbsp;&nbsp;<button type="button" class="btn btn-outline btn-primary">메일 보내기</button>
              &nbsp;&nbsp;<button type="button" class="btn btn-outline btn-primary">주소록 그룹에 추가</button>
        </div>
