				...
				<div id="note" class="tab-pane active">
					<form action="memo_write.do" method="post">
						<div class="form-inline">
							<input type="text" class="form-control" id="memo_plus_title"
								name="title" placeholder="제목 입력"
								style="background-color:; border: 0px;">
							<div class="pull-right">
								<select name="color_no" class="form-control input-xs"
									id="memo_plus_color_no">
						...
						<hr />
						<div class="note-content" id="memo_plus_content_div"
							style="background:;">
							<textarea class="form-control" id="memo_plus_content"
								style="background:;" placeholder="본문 입력" name="memo_content"
								wrap="hard"></textarea>
						</div>
						<div class="pull-right">
							<button class="btn btn-sm btn-default" id="submit_btn">
